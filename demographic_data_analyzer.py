...
def calculate_demographic_data(print_data=True):
    ...
    totals = df["native-country"].value_counts().sort_index()

    totals_rich = df.loc[df["salary"] == ">50K"]
    totals_rich = totals_rich["native-country"].value_counts().sort_index()
    
    percentages = totals_rich.div(totals)
